  ...
  return (
    <div
      className={classNames(
        'group rounded-lg text-sm text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white overflow-hidden flex justify-between items-center px-3 py-2 transition-colors border border-transparent',
        'hover:bg-accent-50/70 dark:hover:bg-accent-500/10 hover:border-accent-100/60',
        isActiveChat && 'text-accent-900 dark:text-white bg-accent-50/80 dark:bg-accent-500/10 border-accent-200/60',
    ...
    >
      ...
      {editing ? (
        <form onSubmit={handleSubmit} className="flex-1 flex items-center gap-2">
          ...
          <button
            type="submit"
            className="i-ph:check h-4 w-4 text-gray-500 hover:text-accent-600 transition-colors"
