    ...
    <>
      <motion.div
        ...
        className={classNames(
          ...
          'bg-white/30 dark:bg-gray-950/40 backdrop-blur-xl border-r border-accent-100/60',
          'shadow-lg text-sm',
          isSettingsOpen ? 'z-40' : 'z-sidebar',
        )}
      >
        <div className="h-12 flex items-center justify-between px-4 border-b border-accent-100/60 bg-white/60 dark:bg-gray-900/50 rounded-tr-2xl">
        ...
        <div className="flex-1 flex flex-col h-full w-full overflow-hidden">
          <div className="p-4 space-y-3">
              ...
              <button
                ...
                className={classNames(
                  ...
                  selectionMode
                    ...
                    : 'bg-white/60 dark:bg-gray-800/60 text-gray-700 dark:text-gray-300 hover:bg-white/80 dark:hover:bg-gray-700 border border-accent-100/60',
                )}
            ...
            <div className="relative w-full">
              ...
              <input
                className="w-full bg-white/60 dark:bg-gray-900/60 relative pl-9 pr-3 py-2 rounded-lg focus:outline-none focus:ring-1 focus:ring-accent-500/50 text-sm text-gray-900 dark:text-gray-100 placeholder-gray-500 dark:placeholder-gray-500 border border-accent-100/60"
                type="search"
