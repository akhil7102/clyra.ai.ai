...
async function getDb() {
  ...
  if (!dbPromise && persistenceEnabled) {
    ...
    async function initializeChat() {
      ...
      if (!database) {
        ...
        if (persistenceEnabled) {
          ...
          console.warn('Chat persistence is unavailable, using in-memory mode');
        }
            ...
            try {
              ...
              if (res.ok) {
                ...
                if (data?.chat) {
                  ...
                  try {
                    await setMessages(database, data.chat.id || mixedId, mapped, data.chat.id || mixedId, data.chat.title, data.chat.created_at);
                  } catch {}
                }
              } else {
